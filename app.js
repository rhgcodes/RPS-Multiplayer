// Initialize Firebase
var config = {
    apiKey: "AIzaSyDsmj29qr66PIiDO1xedtWnoGq8JabxuGk",
    authDomain: "rpsgame-ed204.firebaseapp.com",
    databaseURL: "https://rpsgame-ed204.firebaseio.com",
    projectId: "rpsgame-ed204",
    storageBucket: "rpsgame-ed204.appspot.com",
    messagingSenderId: "423810997017"
  };
  firebase.initializeApp(config);

$(document).on('ready', function () {
	// // Links to Firebase
	var database = new Firebase("https://rpsgame-ed204.firebaseio.com/");
	var presenceRef = new Firebase("https://rpsgame-ed204.firebaseio.com/.info/connected");
	var playersRef = new Firebase("https://rpsgame-ed204.firebaseio.com/playersRef");
	var turnRef = new Firebase("https://rpsgame-ed204.firebaseio.com/turn");
	var chatRef = new Firebase("https://rpsgame-ed204.firebaseio.com/chat");
		...
		listeners: function () {
			...
			database.on("value", function (snapshot) {
				...
				if (turnVal !== null && player == undefined) {
					var wrapper = $('.wrapper');
					var $img = $('<img>').attr('src', "assets/images/rps.jpg");
